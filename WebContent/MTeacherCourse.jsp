...
<%@ page import="java.util.*,com.model.TeacherCourse"%>
	...
	<section>
				...
				<li><a href="managerOp.jsp"><i class="fa fa-home"></i> <span>主页</span></a></li>
					<li class="menu-list"><a href=""><i class="fa fa-tasks"></i>
						...
						<ul class="sub-menu-list">
							<li><a href="#teachertable">教师任课查询</a></li>
						</ul></li>
		...
		<div class="main-content">
			...
			<div class="page-heading">
				<h3>课程查询</h3>
				<ul class="breadcrumb">
					<li><a href="#teachertable">教师任课表</a></li>
					<li><a href="#classtable">班级课程开设表</a></li>
				</ul>
			</div>
			<!-- page heading end-->
					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading">
								教师任课表<span class="tools pull-right"> <a
							...
							<div class="panel-body">
								<div class="adv-table">
									<table class="display table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="course" items="${sessionScope.TeacherCourses}"
												varStatus="status">
												<tr>
													<%--为奇数行和偶数行设置不同的背景颜色--%>
													<td>${course.cno}</td>
