					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="adv-table">
									<form action="updateStudentInfoServlet.do" method="post">
										<table class="display table table-bordered table-striped"
											...
											<tbody>
													<tr>
													<td><input type="text" name="sno" value="${sessionScope.updateStudent.sno}"/></td>
													<td><input type="text" name="name" value="${sessionScope.updateStudent.name}"/></td>
													<td><input type="text" name="sex" value="${sessionScope.updateStudent.sex}"/></td>
													<td><input type="text" name="birth" value="${sessionScope.updateStudent.birth}"/></td>
													<td><input type="text" name="class" value="${sessionScope.updateStudent.sclass}"/></td>
													<td><input type="text" name="phone" value="${sessionScope.updateStudent.phone}" /></td>
