					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading">
								教师信息表 <span class="tools pull-right"> <a
							...
							<div class="panel-body">
								<div class="adv-table">
									<form action="insertTeacherServlet.do" method="post">
											...
											<tbody>
												<c:forEach var="teacher" items="${sessionScope.teachers}"
													...
													<tr>
														...
														<td>${teacher.phone}</td>
														<td><a
															href="updateTeacherServlet.do?tno=${teacher.tno}">修改</a>
															&nbsp;&nbsp; <a
															href="deleteTeacherServlet.do?tno=${teacher.tno}">删除</a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
												...
												<tr>
													<td><input class="form-control" type="text" name="tno" /></td>
													<td><input class="form-control" type="text" name="name" /></td>
													<td><input class="form-control" type="text" name="sex" /></td>
													<td><input class="form-control" type="text" name="birth" /></td>
