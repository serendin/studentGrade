		...
		<div class="left-side sticky-left-side">
			...
			<div class="left-side-inner">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li><a href="findToInputServlet"><i
					...
					<div class="col-sm-6">
						<section class="panel">
							...
							<div class="panel-body">
								<form action="updateMessageTeaServlet" method="post">
									<table class="table">
										<tbody>
											<tr>
											...
											<tr>
												...
												<td><input class="form-control" type="text" name="sex"
													value="${teacher.sex}" /></td>
											</tr>
											<tr>
												<td><strong>出生年月</strong></td>
												<td><input class="form-control" type="text"
													name="birth" value="${teacher.birth}" /></td>
											</tr>
											<tr>
												<td><strong>联系电话</strong></td>
												<td><input class="form-control" type="text"
													name="phone" value="${teacher.phone}" /></td>
											</tr>
										</tbody>
									</table>
