					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="adv-table">
									<form action="insertCourseServlet.do" method="post">
											...
											<tbody>
												<c:forEach var="course" items="${sessionScope.courses}"
													...
													<tr>
														...
														<td>${course.period}</td>
														<td><a
															href="updateCourseServlet.do?cno=${course.cno}">修改</a>
															&nbsp;&nbsp; 
														    <a
															href="deleteCourseServlet.do?cno=${course.cno}">删除</a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
												...
												<tr>
													<td><input class="form-control" type="text" name="cno" /></td>
													<td><input class="form-control" type="text" name="name" /></td>
													<td><input class="form-control" type="text" name="credit" /></td>
													<td><input class="form-control" type="text" name="period" /></td>
