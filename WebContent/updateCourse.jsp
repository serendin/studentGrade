					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="adv-table">
									<form action="updateCourseInfoServlet.do" method="post">
										<table class="display table table-bordered table-striped"
											...
											<tbody>
													<tr>
													<td><input class="form-control" type="text" name="cno" value="${sessionScope.updateCourse.cno}"/></td>
													<td><input class="form-control" type="text" name="name" value="${sessionScope.updateCourse.name}"/></td>
													<td><input class="form-control" type="text" name="credit" value="${sessionScope.updateCourse.credit}"/></td>
													<td><input class="form-control" type="text" name="period" value="${sessionScope.updateCourse.period}"/></td>
