		...
		<div class="left-side sticky-left-side">
			...
			<div class="left-side-inner">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li><a href="findToInputServlet"><i class="fa fa-bar-chart-o"></i> <span>成绩录入</span></a></li>
				</ul>
				<!--sidebar nav end-->
										...
										<tbody>
											<c:forEach var="course" items="${sessionScope.choosedCourses}"
												...
												<tr>
													...
													<td>${course.credit}</td>
													<td>${course.period}</td>
													<td><a href="deleteCourseTeaServlet.do?cno=${course.cno}">删除</a>
												</tr>
											</c:forEach>
										</tbody>
									</table>
				...
				<div class="row">
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="adv-table">
									<form action="insertCourseTeaServlet.do" method="post">
									<input class="btn btn-primary pull-right" type="submit"
										...
										<table class="display table table-bordered table-striped"
											...
											<tbody>
												<c:forEach var="course" items="${sessionScope.unchoosedCourses}"
													varStatus="status">
													<tr>
														<%--为奇数行和偶数行设置不同的背景颜色--%>
														<td>${course.cno}</td>
														...
														<td>
															<div class="flat-grey single-row">
																<div class="radio ">
																	<input type="checkbox" value="${course.cno}"
																		name="cnos">
																</div>
															</div>
														</td>
